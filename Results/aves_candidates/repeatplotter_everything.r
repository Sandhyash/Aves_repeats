...
if (length(args)<6) {
  stop("Please provide arguments like Rscript repeatplotter_everything.r inputfile treefile cladename genename windowsize codemlresult ", call.=FALSE)
}
library(ape)
library(stringr)
library(TreeTools)
...
tabl=paste(gene,"_repeat_summary.txt",sep="")
